...
import 'package:VEIDI_driver/controller/payment_controller.dart';
import 'package:VEIDI_driver/model/ride_model.dart';
import 'package:VEIDI_driver/page/chats_screen/conversation_screen.dart';
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              // ),
                                              Text(
                                                "${Constant.currency}${double.parse(controller.data.value.montant!.toString()).toStringAsFixed(int.parse(Constant.decimal.toString()))}",
                                                style: const TextStyle(
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                    '${Constant.currency.toString()} ${controller.discountAmount.value.toDouble().toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                    style: TextStyle(
                                        letterSpacing: 1.0,
                                        color: ConstantColors.titleTextColor,
                                        fontWeight: FontWeight.w800)),
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                    '${Constant.currency.toString()} ${controller.taxAmount.value.toDouble().toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                    style: TextStyle(
                                        letterSpacing: 1.0,
                                        color: ConstantColors.titleTextColor,
                                        fontWeight: FontWeight.w800)),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                          '${Constant.currency.toString()} ${controller.tipAmount.value.toDouble().toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                          style: TextStyle(
                                              letterSpacing: 1.0,
                                              color:
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                    '${Constant.currency.toString()} ${controller.getTotalAmount().toStringAsFixed(2)}',
                                    style: TextStyle(
                                        letterSpacing: 1.0,
