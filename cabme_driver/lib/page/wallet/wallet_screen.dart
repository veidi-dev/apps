...
import 'package:VEIDI_driver/controller/wallet_controller.dart';
import 'package:VEIDI_driver/model/trancation_model.dart';
                        ...
                        Positioned(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                "${Constant.currency} ${double.parse(walletController.totalEarn.toString()).toStringAsFixed(int.parse(int.parse(Constant.decimal.toString()).toString()))}",
                                style: const TextStyle(
                                    fontSize: 21,
