...
import 'package:VEIDI_driver/controller/ride_details_controller.dart';
                                        ...
                                        child: Padding(
                                          ...
                                          child: Column(
                                            children: [
                                              ...
                                              // ),
                                              Text(
                                                "${Constant.currency}${double.parse(rideData!.montant.toString()).toStringAsFixed(int.parse(Constant.decimal.toString()))}",
                                                style: const TextStyle(
                                            ...
                                            showDialog(
                                                ...
                                                builder:
                                                  ...
                                                  return CustomDialogBox(
                                                    ...
                                                    descriptions:
                                                        "Ride Successfully confirmed you can check ride in on ride section.",
                                                    text: "Ok",
                                                    onPress: () {
                                                      Get.back();
                                                      Get.back();
                                              ...
                                              showDialog(
                                                  ...
                                                  builder:
                                                    ...
                                                    return CustomDialogBox(
                                                      ...
                                                      descriptions:
                                                          "Ride Successfully On ride you can check ride in on ride section.",
                                                      text: "Ok",
                                                      onPress: () {
                                                        Preferences.setString(
                                                            Preferences
                        ...
                        child: Expanded(
                          child: Padding(
                            ...
                            child: ButtonThem.buildBorderButton(
                              ...
                              btnBorderColor: Colors.black.withOpacity(0.20),
                              onPress: () async {
                                Constant.launchMapURl(rideData!.latitudeArrivee,
                                            ...
                                            showDialog(
                                                ...
                                                builder:
                                                  ...
                                                  return CustomDialogBox(
                                                    ...
                                                    descriptions:
                                                        "Ride Successfully completed you can check ride in completed section.",
                                                    text: "Ok",
                                                    onPress: () {
                                                      controllerDashBoard
                                                    ...
                                                    builder:
                                                      ...
                                                      return CustomDialogBox(
                                                        title:
                                                            "Reject Successfully",
                                                        descriptions:
                                                            "Ride Successfully rejected you can check ride in rejected section.",
                                                        text: "Ok",
                                                        onPress: () {
                                                          Get.back();
                                                          Get.back();
