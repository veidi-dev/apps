...
import 'package:VEIDI_driver/controller/document_upload_contoller.dart';
import 'package:VEIDI_driver/controller/documets.dart';
          ...
          bottomNavigationBar: Container(
            ...
            child: Center(
              child: ButtonThem.buildButton(
                ...
                txtColor: Colors.white,
                onPress: () {
                  print(controller.document.length.toString());
                  print(controller.rideList.length.toString());
                  if (controller.document.length ==
                      controller.rideList.length) {
                    print(
                        "${controller.imageList.map((element) => element).toList()}");
                    print(
                        "${controller.document.map((element) => element.toJson()).toList()}");
