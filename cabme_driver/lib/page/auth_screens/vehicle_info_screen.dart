...
import 'package:VEIDI_driver/controller/vehicle_info_controller.dart';
import 'package:VEIDI_driver/model/brand_model.dart';
import 'package:VEIDI_driver/model/model.dart';
import 'package:VEIDI_driver/page/auth_screens/add_profile_photo_screen.dart';
import 'package:VEIDI_driver/page/auth_screens/login_screen.dart';
import 'package:VEIDI_driver/themes/constant_colors.dart';
import 'package:VEIDI_driver/themes/responsive.dart';
import 'package:VEIDI_driver/themes/text_field_them.dart';
                        ...
                        onPressed: () async {
                          ...
                          if (_formKey.currentState!.validate()) {
                            if (vehicleInfoController
                              ...
                              await vehicleInfoController.vehicleRegister(
                                  bodyParams1); /*.then((value) {
                                print('value: $value' );
                                if (value != null) {
                                  print('tamos mesmo?');
