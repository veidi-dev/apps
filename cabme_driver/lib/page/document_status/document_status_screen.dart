...
import 'package:VEIDI_driver/controller/document_status_contoller.dart';
                                            ...
                                            showDialog(
                                              ...
                                              builder: (context) {
                                                return CustomAlertDialog(
                                                  title:
                                                      "Reason : ${controller.documentList[index].comment!.isEmpty ? "Under Verification" : controller.documentList[index].comment.toString()}",
