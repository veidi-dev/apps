...
import 'package:VEIDI_driver/controller/add_review_controller.dart';
...
import 'package:VEIDI_driver/widget/my_separator.dart';
      ...
      builder: (controller) {
        return Scaffold(
          ...
          appBar: AppBar(
              ...
              centerTitle: true,
              title: Text(
                  controller.data.value != null ? "Edit Review" : "Add review",
