...
import 'package:VEIDI_driver/model/get_vehicle_getegory.dart';
import 'package:VEIDI_driver/model/model.dart';
import 'package:VEIDI_driver/model/user_model.dart';
import 'package:VEIDI_driver/model/vehicle_register_model.dart';
  ...
  Future<VehicleRegisterModel?> vehicleRegister(
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('tamos?');
        print(responseBody);
        var v = VehicleRegisterModel.fromJson(responseBody);
        print('criei v');
