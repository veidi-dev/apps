...
import 'package:VEIDI/controller/payment_controller.dart';
import 'package:VEIDI/controller/wallet_controller.dart';
import 'package:VEIDI/model/PayPalCurrencyCodeErrorModel.dart'
    as payPalCurrModel;
import 'package:VEIDI/model/get_payment_txt_token_model.dart';
import 'package:VEIDI/model/payStackURLModel.dart';
import 'package:VEIDI/model/paypalErrorSettle.dart';
import 'package:VEIDI/model/paypalPaymentSettle.dart' as payPalSettel;
import 'package:VEIDI/model/razorpay_gen_orderid_model.dart';
import 'package:VEIDI/model/stripe_failed_model.dart';
import 'package:VEIDI/page/wallet/payStackScreen.dart';
import 'package:VEIDI/page/wallet/paypalclientToken.dart';
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                    '(-)${Constant.currency.toString()} ${controller.discountAmount.value.toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                    style: TextStyle(
                                        letterSpacing: 1.0,
                                        color: ConstantColors.titleTextColor,
                                        fontWeight: FontWeight.w800)),
                            ...
                            Row(
                              children: [
                                ...
                                Text(
                                    '${Constant.currency.toString()} ${controller.taxAmount.value.toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                    style: TextStyle(
                                        letterSpacing: 1.0,
                                        color: ConstantColors.titleTextColor,
                                        fontWeight: FontWeight.w800)),
                                ...
                                children: [
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Text(
                                        '${Constant.currency.toString()} ${controller.tipAmount.value.toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                        style: TextStyle(
                                          letterSpacing: 1.0,
                                          color: ConstantColors.titleTextColor,
                                          fontWeight: FontWeight.w800,
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  '${Constant.currency.toString()}${controller.getTotalAmount().toStringAsFixed(int.parse(Constant.decimal ?? "2"))}',
                                  style: TextStyle(
                                    letterSpacing: 1.0,
                                  ...
                                  children: [
                                    Row(
                                      ...
                                      children: [
                                        ...
                                        const Spacer(),
                                        Text(
                                          "${Constant.currency.toString()} ${strToDouble(controller.walletAmount.value.toString())}",
                                        ),
                                      ],
                                    ),
            ...
            child: Padding(
              ...
              child: Row(
                children: [
                  Expanded(
                    child: Text(
                      "Total : ${Constant.currency.toString()}${controller.getTotalAmount().toStringAsFixed(int.parse(Constant.decimal ?? "2"))}",
