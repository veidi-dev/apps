...
import 'package:VEIDI/controller/dash_board_controller.dart';
import 'package:VEIDI/controller/ride_details_controller.dart';
...
import 'package:VEIDI/themes/custom_alert_dialog.dart';
...
class _RouteViewScreenState extends State<RouteViewScreen> {
  ...
  getArgumentData() {
    if (argumentData != null) {
      ...
      if (rideData!.statut == "on ride" || rideData!.statut == 'confirmed') {
        String orderId = (int.parse(rideData!.idUserApp.toString()) <
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          children: [
                                            ...
                                            Text(
                                              "${Constant.currency.toString()} ${double.parse(rideData!.montant!).toStringAsFixed(int.parse(Constant.decimal ?? "2"))}",
                                              style: const TextStyle(
                                                fontWeight: FontWeight.w800,
                                                color: Colors.black54,
                                              ),
  ...
  getDirections({required double dLat, required double dLng}) async {
    ...
    log('Lat ${double.parse(rideData!.latitudeDepart.toString())}');
    log('Lng ${double.parse(rideData!.longitudeDepart.toString())}');
