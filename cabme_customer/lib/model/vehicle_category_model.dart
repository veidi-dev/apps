...
class VehicleData {
  ...
  VehicleData.fromJson(Map<String, dynamic> json) {
    ...
    deliveryCharges = json['delivery_charges'] ?? '0.0';
    minimumDeliveryCharges = json['minimum_delivery_charges'] ?? '0.0';
    minimumDeliveryChargesWithin = json['minimum_delivery_charges_within'] ?? '0.0';
  }
